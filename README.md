...
output/            generated parquet artifacts (not tracked in git, see below)
...
follow [docs/analysis-workflow.md](docs/analysis-workflow.md) — output files are
intentionally not tracked in git, so PRs stay text-only.
